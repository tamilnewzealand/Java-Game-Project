...
public class GUIComponent {
	...
	public static Text createText(String text, double x, double y, int fontSize) {
		...
		try {
            textUI.setFont(Font.loadFont(new FileInputStream(new File("Kavivanar.TTF")), fontSize));
	...
	public static Button createButton(String text, double x, double y, double width, double height, int fontSize) {
		...
		try {
            buttonUI.setFont(Font.loadFont(new FileInputStream(new File("Kavivanar.TTF")), fontSize));
        } catch (FileNotFoundException e) {
            e.printStackTrace();
        }  
